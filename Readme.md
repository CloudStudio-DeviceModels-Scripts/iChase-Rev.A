...
# Configuration Script – iChase - Rev. A

This **Configuration** script is designed for the **iChase** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – iChase Rev. A

Este script de **Configuration** está diseñado para el modelo **iChase** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
